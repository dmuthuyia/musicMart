...
class ArtistController extends Controller
{
	...
	public function trybsSignUp(Request $request)
		...
		//Mail::send('mails.verify', $thisdata, function($message) use ($thisdata){
			...
			//$message->from('goldensparkleservices@kenyan-love.com');
...
//        Flash::message('Thanks for signing up! Please check your email.');
	...
	public function getIndex()
		{
			...
			//$users = Artist::orderBy('created_at', 'desc')->get()
			$users = Artist::orderBy('created_at', 'desc')->paginate(12);
    ...
    public function getShow($id)
    {
        ...
        $user = Artist::where('id', $id)->firstOrFail();
        //$interested = Artist::where('id', '!=', $id)->get();
        $interested = Artist::where('id', '!=', $id)->get()->random(3);
    ...
    {
        $user= Artist::find($id);
        return view('ArtistCRUD.edit',compact('user'));
    }
     ...
     public function confirm($confirmation_code)
    {
        ...
        $user = Artist::whereConfirmationCode($confirmation_code)->first();
