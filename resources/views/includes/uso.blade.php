...
<body>
    ...
    <div id="dcarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <img src="{{url('/assets/images/uso/banner1.png')}}" alt="Image"/>
            ...
            <img src="{{url('/assets/images/uso/banner2.png')}}" alt="Image"/>
            ...
            <img src="{{url('/assets/images/uso/banner3.png')}}" alt="Image"/>
